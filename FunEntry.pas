...
uses
  ...
  Dialogs, Grids, StdCtrls, ExtCtrls, DateUtils, FunGrid, ComCtrls,System.UITypes;
...
{save button}
var
   I,J,K,L,Ents,Ind,RecNo,NStar,Strt,Stop:integer;
...
begin
   ...
   DowName.Caption:=Formset.LongDayNames[DayOfWeek(NewDate+CurCol-1)];
...
var
   I,J,TId,SId,Ents,OStar,OStop,NStop,SMins,AMins:integer;
   S,T,CellStr,TStar,TStop,DS,Test:string;
